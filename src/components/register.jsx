      ...
      <div className='flex min-h-screen'>
        ...
        <div className='flex flex-col items-center justify-center w-6/12'>
          <div className='flex flex-col min-h-[400px] justify-center p-2 rounded-md w-6/12'>
            <p className='font1 text-left text-2xl'>Create account</p>
            ...
            <div className='flex justify-between mt-2'>
              ...
              <span className='font2 text-sm'>Forgot password</span>
            </div>

            <button className='bg-gradient-to-r font-bold from-gray-800 to-gray-600 mt-6 p-2 rounded-md text-white w-full'>Sign up</button>
            <button className='border border-gray-600 font-bold mt-3 p-2 rounded-md text-gray-600 w-full'>
              Sign up with G<span className='text-orange-400'>o</span><span className='text-red-500'>o</span>gl<span className='text-blue-600'>e</span>
            </button>

            <p className='mt-4 text-center text-sm'>
              Already a member? 
              <span className='cursor-pointer font-bold hover:text-purple-800 mx-1'>Sign in</span>
            </p>
